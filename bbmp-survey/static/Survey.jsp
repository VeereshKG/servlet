...
<div class="container mt-4 mb-5">
    ...
    <form action="survey" method="post" class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="shoeSize" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="rationCard" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="sites" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="insuranceNo" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="electricityBill" class="form-control">
        </div>

        <div class="col-md-4">
            <label class="form-label">Water Bill No</label>
            <input type="text" name="waterBill" class="form-control">
        </div>

        <div class="col-md-4">
            <label class="form-label">Building Owner Name</label>
            <input type="text" name="buildingOwner" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="rtc" class="form-control">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="number" name="cows" class="form-control">
        </div>
