...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center" href="Search.jsp">SearchByVehicleNumber</a>
        <a class="navbar-brand d-flex align-items-center" href="SearchByVehicleType.jsp">SearchByVehicleType</a>
    ...
    <div class="card shadow-lg p-2 border-0 rounded-2">
        ...
        <form id="insuranceForm" action="insurance" method="post" onsubmit="return validateForm()">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="ownerName" name="ownerName" class="form-control" value="${preData.ownerName}"
            ...
            <div class="mb-3">
                ...
                <input type="text" id="vehicleNumber" name="vehicleNumber" class="form-control" value="${preData.vehicleNumber}"
                       placeholder="KA-01-AB-1234">
                <small id="vehicleErr"></small>
            </div>
            <div class="mb-3">
                <label class="form-label fw-bold">Vehicle Type<span style="color:red">*</span></label>
                <input type="text" id="vehicleType" name="vehicleType" class="form-control" value="${preData.vehicleType}"
            ...
            <div class="mb-3">
                ...
                <input type="number" id="premium" name="amount" class="form-control" value="${preData.amount}"
